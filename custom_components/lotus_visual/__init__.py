"""Lotus Visual: visual dashboard editing suite for Home Assistant."""
...
from .const import BRAND_URL, DOMAIN, MODULE_URL, PANEL_ICON, PANEL_PATH, PANEL_TITLE, URL_BASE
...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    """Set up Lotus Visual from YAML (no YAML configuration is required)."""
    return True


async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up Lotus Visual from a config entry."""
