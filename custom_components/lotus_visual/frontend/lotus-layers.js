	...
	Re(), Xe(), H(), ht(), Z = class extends F {
		...
		_getTypeLabel(e) {
			if (e === "custom:lotus-card-element") {
				if (lotusIsVisualStackCard(this.element?.card)) return "Lotus Visual Stack";
		...
		_renderSubEditor() {
            ...
            <div class="sub-editor">
                <div class="sub-header">
                    ...
                    <div>
                        <strong>${n ? s ? "Lotus Visual Stack" : lotusGetCustomCardInfo(t.card.type)?.name ?? t.card.type : this._t("editor.editElement")}</strong>
